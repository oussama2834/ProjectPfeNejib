...
import {
    ...
    InventoryTag,
    InventoryVendor,
} from 'app/modules/admin/apps/ecommerce/articles/inventory.types';
import {
    debounceTime,
    map,
    merge,
    ...
    implements OnInit, AfterViewInit, OnDestroy
{
    ...
    constructor(
        ...
        private _inventoryService:ArticleService
    ) {}
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._inventoryService.listArticles(
                        0,
                        10,
                        'name',
                        'asc',
 ...
 */
  ...
  /*   shouldShowCreateTagButton(inputValue: string): boolean {
    ...
    ajoutArticle(): void {
        // Create the product
        this._inventoryService.ajoutArticle().subscribe((newProduct) => {
            // Go to new product
    ...
    updateSelectedProduct(): void {
        ...
        this._inventoryService
            .updateArticle(product.id, product)
            .subscribe(() => {
